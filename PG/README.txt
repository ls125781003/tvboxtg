...
提示4：因爲32bit的aliproxy在加速大文件時cpu負載很高，因此默認使用64bit的aliproxy來加速播放，通常較新的盒子或電視都可以無需任何修改直接運行。如果你的設備無法觀看網盤原畫，那麽在排除了使用非原版“影視”“OK影視”“EasyBox”的基礎上，可以嘗試把tokenm.json中的"aliproxy_url"設置爲"aliproxy_url":"./aliproxy.32.gz"這樣就可以使用32bit的aliproxy來加速播放，雖然效率較低，但至少能播。
