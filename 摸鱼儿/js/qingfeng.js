var rule = {
    ...
    proxy_rule: $js.toString(() => {
        if (input) {
            //console.log(url);   
            var url = `http://dm.sds11.top/tdm.php?url=` + input.url;
            var htt = fetch(url);
